...
import PokemonOfficialAvatar from '../../Profile Components/PokemonOfficialAvatar';
import ProfilePokemonMoves from '../../Profile Components/ProfilePokemonMoves';
import ProfilePokemonStat from '../../Profile Components/ProfilePokemonStat';

const SocialDetailShowcase = ({ pokemonData }) => {
  return (
    <div
...
export default SocialDetailShowcase;
